...
public class FullScreenZoomFragment extends Fragment {
...
//    private DisplayImageOptions options;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_full_screen_slide_page, container, false);

        TwoLevelDoubleTapZoomNetworkImageView imageView = (TwoLevelDoubleTapZoomNetworkImageView)rootView.findViewById(R.id.image);//Resmin gösterilcegi controller
